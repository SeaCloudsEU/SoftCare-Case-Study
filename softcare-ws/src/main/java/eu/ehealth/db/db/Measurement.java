...
public class Measurement  implements java.io.Serializable {
    ...
    public Measurement(String type, BigDecimal value, Timestamp datetime, String units, BigDecimal lowerlimit, BigDecimal upperlimit, Integer patientassessment, Integer task, PatientAssessment m_PatientAssessment, Task m_Task) {
       this.type = type;
       this.value = value;
